...
/**
 * @brief In the following line adjust the value of Internal Medium Speed oscillator (MSI)
   used in your application 
   
   Tip: To avoid modifying this file each time you need to use different MSI, you
        can define the MSI value in your toolchain compiler preprocessor.
  */
#if !defined  (MSI_VALUE)
#define MSI_VALUE    ((uint32_t)2097000) /*!< Value of the External oscillator in Hz */
#endif
