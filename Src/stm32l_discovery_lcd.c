...
*/
      LCD->RAM[LCD_RAMRegister_0] &= 0x3fcfffff;
      LCD->RAM[LCD_RAMRegister_2] &= 0x3fcfffff;
      LCD->RAM[LCD_RAMRegister_4] &= 0x3fcfffff;
      LCD->RAM[LCD_RAMRegister_6] &= 0x3fcfffff;
      
      LCD->RAM[LCD_RAMRegister_0] |= ((digit[0]& 0x0c) << 18 ) | ((digit[0]& 0x03) << 30 ) ; // 4G 4B 4M 4E	
      LCD->RAM[LCD_RAMRegister_2] |= ((digit[1]& 0x0c) << 18 ) | ((digit[1]& 0x03) << 30 ) ; // 4F 4A 4C 4D
      LCD->RAM[LCD_RAMRegister_4] |= ((digit[2]& 0x0c) << 18 ) | ((digit[2]& 0x03) << 30 ) ; // 4Q 4K 4Col 4P
      LCD->RAM[LCD_RAMRegister_6] |= ((digit[3]& 0x0c) << 18 ) | ((digit[3]& 0x03) << 30 ) ; // 4H 4J 4DP 4N
